          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="footer-info">
                <p> ©&nbsp;<?php echo app('translator')->get('website.Copy Rights'); ?>, Todos os Direitos Reservados
                  <a href="<?php echo e(url('/page?name=refund-policy')); ?>"><?php echo app('translator')->get('website.Privacy'); ?></a>
                  &nbsp;•&nbsp;
...
</footer><?php /**PATH C:\xampp\htdocs\food-routine_web\resources\views/web/footers/footer1.blade.php ENDPATH**/ ?>