...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> <?php echo e(trans('labels.Nutritional Information')); ?> <small><?php echo e(trans('labels.ListingAllNutritionalsInformation')); ?>...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.breadcrumb_dashboard')); ?></a></li>
            <li class="active"><?php echo e(trans('labels.Nutritional Information')); ?></li>
        </ol>
    </section>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\food-routine\food-routine_web\resources\views/admin/currencies/index.blade.php ENDPATH**/ ?>