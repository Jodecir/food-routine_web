		...
		<div class="row">
			...
			<div class="col-lg-4 col-xs-6">
				...
				<div class="small-box bg-teal">
					<div class="inner">
						<h3><?php if(!empty($result['commonContent']->symbol_left)): ?> <?php echo e($result['commonContent']->symbol_left); ?> <?php endif; ?> <?php echo e($result['profit']); ?> <?php if(!empty($result['commonContent']->symbol_right)): ?> <?php echo e($result['commonContent']->symbol_right); ?> <?php endif; ?></h3>
						<p><?php echo e(trans('labels.Total Kcal Consumed')); ?></p>
					</div>
					<div class="icon">
						<i class="ion ion-flash"></i>
					</div>
					<a href="<?php echo e(URL::to('admin/orders/display')); ?>" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.viewAllMeals')); ?>"><?php echo e(trans('labels.viewAllMeals')); ?> <i class="fa fa-arrow-circle-right"></i></a>
				</div>
			</div>
			<!-- ./col -->
			<div class="col-lg-4 col-xs-6">
			...
			<div class="col-md-8">
					...
					<div class="box box-info">
							...
							<div class="box-footer clearfix">
									...
									<a href="<?php echo e(URL::to('admin/orders/display')); ?>" class="btn btn-sm btn-default btn-flat pull-right" data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.viewAllMeals')); ?>"><?php echo e(trans('labels.viewAllMeals')); ?></a>
							</div>
							<!-- /.box-footer -->
					</div>
					<!-- /.box -->
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\food-routine_web\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>