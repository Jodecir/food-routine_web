  ...
  <div class="login-logo">
  	...
  	<?php if(empty($web_setting[15]->value)): ?>
        <?php if($web_setting[66]->value=='1' and $web_setting[67]->value=='0'): ?>
      		<img src="<?php echo e(asset('images/admin_logo/logofoodroutine.png')); ?>" class="ionic-hide">
        	<img src="<?php echo e(asset('images/admin_logo/logofoodroutine.png')); ?>" class="android-hide">
        <?php elseif($web_setting[66]->value=='1' and $web_setting[67]->value=='1' or $web_setting[66]->value=='0' and $web_setting[67]->value=='1'): ?>
   			<img src="<?php echo e(asset('images/admin_logo/logofoodroutine.png')); ?>" class="website-hide">
    	<?php endif; ?>
    <?php else: ?>
...
<?php echo $__env->make('admin.layoutLlogin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\food-routine\food-routine_web\resources\views/admin/login.blade.php ENDPATH**/ ?>