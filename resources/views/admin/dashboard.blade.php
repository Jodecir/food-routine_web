	...
	<section class="content">
					...
					<div class="box box-info">
                          ...
                          <tr>
							...
							<div class="box-footer clearfix">
									...
									<a href="{{ URL::to('admin/orders/display') }}" class="btn btn-sm btn-default btn-flat pull-right" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.viewAllMeals') }}">{{ trans('labels.viewAllMeals') }}</a>
							</div>
							<!-- /.box-footer -->
					</div>
					<!-- /.box -->
        ...
        <div class="box box-primary">
            ...
            <!-- /.progress-group -->
                @if($result['total_orders']>0)
                    <div class="progress-group">
                        <span class="progress-text">{{ trans('labels.MealsUnderAnalysis') }}</span>
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.RecentlyAddedDishs') }}</h3>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
                    <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
