...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.Nutritional Information') }} <small>{{ trans('labels.ListingAllNutritionalsInformation') }}...</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
            <li class="active">{{ trans('labels.Nutritional Information') }}</li>
        </ol>
    </section>
